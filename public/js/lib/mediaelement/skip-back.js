  ...
  */
	buildskipback: function buildskipback(player, controls, layers, media) {
		var t = this,
		    ...
		    //skipTitle = mejs.Utils.isString(t.options.skipBackText)
		    skipTitle = (typeof t.options.skipBackText == 'string' || t.options.skipBackText instanceof String)
          ? t.options.skipBackText.replace('%1', t.options.skipBackInterval)
          : defaultTitle;
