  ...
  */
	buildjumpforward: function buildjumpforward(player, controls, layers, media) {
		var t = this,
		    ...
		    forwardTitle = (typeof t.options.jumpForwardText == 'string' || t.options.jumpForwardText instanceof String)
          ? t.options.jumpForwardText.replace('%1', t.options.jumpForwardInterval)
          : defaultTitle;
